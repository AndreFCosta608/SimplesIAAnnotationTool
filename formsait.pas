...
begin
  ...
  imgTemp.Picture.LoadFromFile(caminho);
  imageHeight := imgTemp.Picture.Height;
  imageWidth := imgTemp.Picture.Width;
  imgTemp.Free;
...
begin
     if(chCross.Checked = True) then begin
         ...
         showImage.Canvas.Ellipse(round(ponto.x - (larguraCirculo)), round(ponto.y  - (larguraCirculo)), (ponto.x + larguraCirculo), (ponto.y + larguraCirculo));
...
begin
     StatusBar1.Panels.Items[8].Text := '  Version: 0.2.1';
     self.WindowState := wsMaximized;
     showImage.Picture.LoadFromFile('fundoBranco.png');
end;
